...
xdata=np.logspace(1.e-5,2*3.14159,1000)
...
#plot bad cosine fit
plt.plot(x,ybad,'r',label='bad theory')

#plot additional data points
#plt.plot(xdata,ydata,'r^',label='data',markersize=14)
#plt.errorbar(xdata,ydata,xerr=.05,yerr=.7,fmt='r^',capsize=5,markersize=14,label='data')
